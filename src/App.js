                ...
                {singleFiles.map((file, index) =>
                  <div className="col-6">
                    <div className="card mb-2 border-0 p-0">
                      <img src={`http://localhost:8080/${file.filePath}`} height="220" width="300" className="card-img-top img-responsive" alt="" />
                    </div>
                  </div>
                )}
              </div>
                  ...
                  <div className="row">
                    {file.files.map((pic) =>
                      <div className="col-6 border">
                        <div className="card mb-2 border-0 p-0">
                          <img src={`http://localhost:8080/${pic.filePath}`} height="220" width="400" className="card-img-top img-responsive" alt="" />
                        </div>
                      </div>
                    )}
                  </div>
